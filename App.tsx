...
const profileData = {
  ...
  // This path is relative to the location of the App.tsx file.
  // The 'require' function correctly loads the local image asset.
  image: require('./pics/adriennerei.JPG'),
  fullName: 'Adrienne Rei H. Cabristante',
  username: 'adriennerei',
  bio: 'hindi ko din alam anong isusulat ko dito',
